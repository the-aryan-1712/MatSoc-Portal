      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="max-w-xl mx-auto text-lg text-foreground/70">
            Access study materials, past presentations, and important research
            papers.
          </p>
        </motion.div>
              ...
              <ul className="space-y-4 flex-1">
                {category.items.map((item, i) => (
                  <li key={i} className="group relative">
                    <a
                      href={getDownloadLink(item.link)}
                      download
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center p-3 rounded-xl bg-foreground/5 hover:bg-primary/10 transition-colors border border-transparent hover:border-primary/20"
                    >
