        ...
        <div className="space-y-24">
          {team.map((group, groupIdx) => (
            <div key={groupIdx}>
              ...
              <div className={group.category === "Secretaries" ? "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4" : "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8"}>
                {group.members.map((member, idx) => (
                  group.category === "Secretaries" ? (
                    ...
                    >
                      <h4 className="font-bold text-base md:text-lg text-foreground">{member.name}</h4>
                    </motion.div>
                  ) : (
                    <motion.div
                      key={member.id}
